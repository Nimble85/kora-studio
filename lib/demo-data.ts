...
export const products: Product[] = [
  ...
  { id: 'coconut-regular-small', name: 'Звичайний кокос · малий', category: 'coconut', price: 550, active: true, waxMinGrams: 80, waxMaxGrams: 130 },
  { id: 'coconut-regular-medium', name: 'Звичайний кокос · середній', category: 'coconut', price: 750, active: true, waxMinGrams: 140, waxMaxGrams: 190 },
  { id: 'coconut-regular-large', name: 'Звичайний кокос · великий', category: 'coconut', price: 950, active: true, waxMinGrams: 200, waxMaxGrams: 280 },
  ...
  { id: 'workshop-individual', name: 'МК індивідуальний', category: 'workshop', price: 2000, active: true },
  { id: 'workshop-two', name: 'МК на двох · з людини', category: 'workshop', price: 1850, active: true },
  { id: 'workshop-three', name: 'МК для 3-х · з людини', category: 'workshop', price: 1650, active: true },
  { id: 'workshop-group-wood', name: 'МК груповий · свічка в дереві', category: 'workshop', price: 1600, active: true },
  { id: 'workshop-company-wood', name: 'МК для своєї компанії (від 4-х) · свічка в дереві', category: 'workshop', price: 1400, active: true },
  { id: 'workshop-group-bali', name: 'МК груповий · свічка в балійському кокосі', category: 'workshop', price: 1400, active: true },
  { id: 'workshop-company-bali', name: 'МК для своєї компанії (від 4-х) · свічка в балійському кокосі', category: 'workshop', price: 1200, active: true },
  { id: 'workshop-group-coconut', name: 'МК груповий · свічка в звичайному кокосі', category: 'workshop', price: 750, active: true },
  { id: 'workshop-company-coconut', name: 'МК для своєї компанії (від 4-х) · свічка в звичайному кокосі', category: 'workshop', price: 650, active: true },
  { id: 'workshop-group-plaster', name: 'МК груповий · свічка в гіпсі', category: 'workshop', price: 950, active: true },
  { id: 'workshop-company-plaster', name: 'МК для своєї компанії (від 4-х) · свічка в гіпсі', category: 'workshop', price: 850, active: true },
  { id: 'workshop-group-plaster-art', name: 'МК груповий · свічка в гіпсі АРТ', category: 'workshop', price: 1250, active: true },
  { id: 'workshop-company-plaster-art', name: 'МК для своєї компанії (від 4-х) · свічка в гіпсі АРТ', category: 'workshop', price: 1150, active: true },
  { id: 'workshop-group-glass-small', name: 'МК груповий · свічка в склі мала', category: 'workshop', price: 550, active: true },
  { id: 'workshop-company-glass-small', name: 'МК для своєї компанії (від 4-х) · свічка в склі мала', category: 'workshop', price: 450, active: true },
  { id: 'workshop-group-glass-large', name: 'МК груповий · свічка в склі велика', category: 'workshop', price: 750, active: true },
  { id: 'workshop-company-glass-large', name: 'МК для своєї компанії (від 4-х) · свічка в склі велика', category: 'workshop', price: 650, active: true },
];
